package cn.zifangsky.third.api;
...
public class TushareApi {
   ...
   public  static String formatCode(String code) {
    ...
    public List<StockCodeInfo>  stocks() {

        JSONArray jsonArray = getStockCodeList();

        List<StockCodeInfo> stockCodeInfoList = Lists.newArrayList();

        for (int i = 0; i < jsonArray.size(); i++) {

            StockCodeInfo stockCodeInfo = new StockCodeInfo(jsonArray.getJSONArray(i));
